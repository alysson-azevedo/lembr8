...
- `AGENTS.md` — este arquivo: modo de trabalho e ponteiros. Fonte única de instruções para qualquer agente (Claude, opencode, Codex, etc.).
- `CLAUDE.md` — atalho para `AGENTS.md` (mantido para compatibilidade com o Claude Code).
