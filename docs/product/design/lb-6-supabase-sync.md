...
**Issue:** [LB-6](https://linear.app/alysson-azevedo/issue/LB-6/persistencia-local-first-das-listas-no-supabase-sync-cross-device) · **State alvo:** 🚧 Dev in progress · **Base:** LB-5 (✅ Deployed v0.3.0)
